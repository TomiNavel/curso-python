...
### R1. ¿Cuál es la diferencia entre un iterable y un iterador en Python?
...
### R2. ¿Qué métodos debe implementar una clase para ser considerada un iterador?
...
### R3. ¿Qué ocurre exactamente cuando Python ejecuta un bucle `for x in obj`?
...
### R4. ¿Qué es `StopIteration` y por qué no debe capturarse normalmente desde código de usuario?
...
### R5. ¿Qué es una función generadora y en qué se diferencia de una función normal?
...
### R6. ¿Qué diferencia hay entre una list comprehension y una generator expression? ¿Cuándo conviene usar cada una?
...
### R7. ¿Qué hace exactamente `yield from` y por qué es preferible a un bucle con `yield`?
...
### R8. ¿Cómo pueden representarse secuencias infinitas en Python sin agotar la memoria?
...
### R9. ¿Qué hace el método `send` de un generador y para qué se utiliza?
...
### R10. ¿Qué ventajas aporta `itertools` frente a escribir bucles manuales?
...
### R11. ¿Por qué un generador solo puede recorrerse una vez?
...
### R12. ¿Qué es la evaluación perezosa y qué ventajas tiene sobre la evaluación ávida?

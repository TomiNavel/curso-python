...
### R1. ¿Qué son los type hints en Python y qué efecto tienen en tiempo de ejecución?
...
### R2. ¿Cuál es la diferencia entre `Optional[str]` y un parámetro con valor por defecto?
...
### R3. ¿Cómo se anota una tupla de longitud fija y una de longitud variable?
...
### R4. ¿Qué es `Any` y cuándo es apropiado usarlo?
...
### R5. ¿Qué es un `TypeVar` y qué problema resuelve?
...
### R6. ¿Cómo se anota una función que recibe otra función como parámetro?
...
### R7. ¿Qué diferencia hay entre `dict[str, int]` y un `TypedDict`?
...
### R8. ¿Qué indica `Final` y qué ocurre si se reasigna un valor marcado como `Final`?
...
### R9. ¿Qué es `Literal` y en qué se diferencia de un Enum?
...
### R10. ¿Qué es mypy y qué tipo de errores detecta?
...
### R11. ¿Cómo se resuelve el error de mypy «X has no attribute Y» cuando el tipo es una unión?
...
### R12. ¿Cuál es la diferencia entre `list` y `List` (de typing) en las anotaciones?

...
### R1. ¿Qué es una dataclass y qué problema resuelve?
...
### R2. ¿Qué métodos genera automáticamente el decorador `@dataclass` por defecto?
...
### R3. ¿Por qué las anotaciones de tipo son obligatorias en los campos de una dataclass?
...
### R4. ¿Por qué no se puede usar una lista como valor por defecto de un campo y cómo se soluciona?
...
### R5. ¿Qué hace `frozen=True` y qué implicaciones tiene sobre `__hash__`?
...
### R6. ¿Qué genera `order=True` y cómo decide el orden de comparación entre campos?
...
### R7. ¿Qué es `slots=True` y qué ventajas e inconvenientes tiene?
...
### R8. ¿Cuándo se utiliza `__post_init__` y qué ocurre dentro de él?
...
### R9. ¿Qué es un Enum y en qué se diferencia de usar cadenas o números mágicos?
...
### R10. ¿Cuál es la diferencia entre `Enum`, `IntEnum` y `StrEnum`?
...
### R11. ¿Cómo se accede a un miembro de un Enum por su nombre y por su valor?
...
### R12. ¿Cómo se itera sobre un Enum y en qué orden se obtienen los miembros?
